  ...
  this.Faq = (function() {
    ...
    function Faq(container) {
      ...
      this.toc = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          el = _ref[_i];
          _results.push($("<li><span class='faq-number'>" + (++i) + "</span> <a class='faq-question-link' href='#faq-question-" + i + "'>" + (el.q.text()) + "</a></li>"));
        }
        return _results;
      }).call(this);
      i = 0;
...
(function() {
  ...
  $(function() {
    ...
    $("input[type='checkbox'], input[type='radio'], input[type='file'], .uniform input").uniform();
    $(".mini-stats-line.green").peity("line", {
      colour: "#91B81F",
      strokeColour: "#537F06"
    });
    $(".mini-stats-line.yellow").peity("line", {
      colour: "#F4BA28",
      strokeColour: "#CB9109"
    });
    $(".mini-stats-line.purple").peity("line", {
      colour: "#6D4895",
      strokeColour: "#3A215B"
    });
    $(".mini-stats").css({
    ...
    $(".box a[class!='faq-question-link']").click(function(e) {
...
(function() {
  var AppyDocumentation,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  AppyDocumentation = (function() {

    function AppyDocumentation(container) {
      this.container = container;
    ...
    AppyDocumentation.prototype.menuSelected = function(e) {
      var id, link, title;
      link = $(e.target);
    ...
    return AppyDocumentation;

  })();

  $(function() {
    return new AppyDocumentation($("#appy-documentation"));
  });

}).call(this);
(function() {
  var ChartOptions, Charts;

  ChartOptions = (function() {

    function ChartOptions() {}

    ChartOptions.colors = ["#E2C348", "#eb6841", "#2790B0", "#777", "#555", "#999", "#bbb", "#ccc", "#eee"];
  ...
  Charts = (function() {
    ...
    Charts.pie = function(el) {
      var data;
      data = [
        {
          label: "Uptime",
          data: Math.floor(Math.random() * 100 + 950)
        }, {
          label: "Downtime",
      ...
      if (el.length) {
        return $.plot(el, data, ChartOptions.pie);
      }
    };

    Charts.getRandomData = function(totalPoints) {
    ...
    Charts.getRandomFloatData = function(totalPoints) {
      var data, prev, y;
      if (totalPoints == null) {
        totalPoints = 30;
      }
  ...
  $(function() {
    if ($("#stats1").length) {
      $.plot($("#stats1"), [Charts.getRandomData()], ChartOptions.line2);
    }
    if ($("#stats2").length) {
      return $.plot($("#stats2"), [Charts.getRandomData()], ChartOptions.line2);
    }
  });

  $(function() {
    var d1, d2, data, dt1, dt2, el5, i, st;
    el5 = $("#chart5");
    if (el5.length) {
      d1 = Charts.getRandomFloatData();
      d2 = Charts.getRandomFloatData();
      dt1 = [];
      dt2 = [];
      st = new Date(2012, 11, 2).getTime();
      i = 0;
      while (i < d2.length) {
      ...
      if (el5.length) {
        return $.plot(el5, data, ChartOptions.line3);
      }
    }
  });

  $(function() {
    var ctx, d1, data, el1, i, markings, o, placeholder, plot;
    el1 = $("#chart1");
    if (el1.length) {
      d1 = [];
      i = 0;
  ...
  $(function() {
    var doPlot, el2, euroFormatter, exchangerates, oilprices;
    el2 = $("#chart2");
    if (el2.length) {
  ...
  $(function() {
    ...
    if (el3.length) {
      ...
      previousPoint = null;
      el3.bind("plothover", function(event, pos, item) {
        var x, y;
        ...
        if ($("#enableTooltip:checked").length > 0) {
          if (item) {
            if (previousPoint !== item.dataIndex) {
              ...
              return showTooltip(item.pageX, item.pageY, item.series.label + " of " + x + " = " + y);
            }
          } else {
            $("#tooltip").remove();
      ...
      return el3.bind("plotclick", function(event, pos, item) {
        if (item) {
  ...
  $(function() {
    var data, el4, getRandomData, options, plot, totalPoints, update, updateInterval;
    el4 = $("#chart4");
    if (el4.length) {
      data = [];
      totalPoints = 200;
      ...
      plot = $.plot(el4, [getRandomData()], options);
      return update();
    }
  });
      ...
      events: [
        {
          ...
          end: new Date(y, m, 15, 22, 0),
          allDay: false
        }, {
          id: 999,
          title: "Repeating event",
          start: new Date(y, m, 18, 21, 0),
          end: new Date(y, m, 19, 24, 0),
          allDay: false
        }, {
          title: "Lunch",
          ...
          title: "Go to Wrapboostrap!",
          start: new Date(y, m, 28),
          end: new Date(y, m, 30),
          url: "http://www.wrapbootstrap.com"
        }
      ]
    });
  });
...
(function() {
  ...
  $(function() {
    ...
    return $(".growl-success").click(function() {
